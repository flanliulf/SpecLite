...
`SpecLite SDLC Module` 将 Workflow 按 Analysis、Planning、Solutioning、Implementation、DevOps 五个阶段组织。各阶段的 canonical 目录、catalog phase、职责、典型 Workflow 与典型产物以 [`../reference/sdlc-phases.md`](../reference/sdlc-phases.md) 为唯一源定义，本文不再重复该表。
