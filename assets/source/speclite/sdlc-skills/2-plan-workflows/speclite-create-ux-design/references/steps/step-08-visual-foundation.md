...
- Invoke the `speclite-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `speclite-party-mode` skill with the current visual foundation
