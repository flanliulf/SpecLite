...
- Invoke the `speclite-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `speclite-party-mode` skill with the current component strategy
