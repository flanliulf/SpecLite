...
- Invoke the `speclite-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `speclite-party-mode` skill with the current emotional response definition
