...
- Invoke the `speclite-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `speclite-party-mode` skill with the current inspiration analysis
