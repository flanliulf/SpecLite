# Validate PRD Workflow Details

# PRD Validate Workflow

**Goal:** Validate existing PRDs against Speclite standards through comprehensive review.
...
**Validate Mode: Validating an existing PRD against Speclite standards.**
