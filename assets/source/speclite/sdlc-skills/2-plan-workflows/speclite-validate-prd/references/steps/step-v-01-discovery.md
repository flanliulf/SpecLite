...
This file contains the Speclite PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great Speclite PRD.
...
- IF A: Invoke the `speclite-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `speclite-party-mode` skill, and when finished redisplay the menu
