...
Detect if PRD follows Speclite format and route appropriately - classify as Speclite Standard / Speclite Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for Speclite PRD Core Sections

Check if the PRD contains the following Speclite PRD core sections:
...
- Follows Speclite PRD structure closely

**Speclite Variant:**
- 3-4 core sections present
- Generally follows Speclite patterns but may have structural differences
- Missing some sections but recognizable as Speclite-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow Speclite PRD structure
...
**Speclite Core Sections Present:**
...
**Format Classification:** [Speclite Standard / Speclite Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is Speclite Standard or Speclite Variant:**
...
This PRD does not follow Speclite standard structure (only {count}/6 core sections present).
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach Speclite PRD parity
...
- Speclite core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- Speclite Standard/Variant PRDs proceed directly to next validation step
