...
- When 'A' selected: Run this step's Advanced Elicitation branch
- When 'P' selected: Run this step's Party Mode branch
...
- Run the Advanced Elicitation branch with specific decision categories
...
- Run the Party Mode branch with architectural decisions context
