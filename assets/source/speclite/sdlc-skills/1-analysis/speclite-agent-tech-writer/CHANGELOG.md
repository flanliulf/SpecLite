...
- 从 `vault/bmad-skills-src/bmm-skills/1-analysis/bmad-agent-tech-writer` 迁移 Taylor / Technical Writer Agent 定义。
...
- 本地 prompt 保留源 Agent 的轻量指令形态；复杂文档生成质量仍依赖 Taylor 与用户的后续对话澄清。
