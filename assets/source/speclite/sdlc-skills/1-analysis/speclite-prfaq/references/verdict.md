...
**Output Location:** selected directory of `{prfaq_main_artifact}` and `{prfaq_distillate_artifact}`
...
**Always produce the distillate** at `{prfaq_distillate_artifact}`:
...
**PRFAQ:** `{prfaq_main_artifact}`
**Detail Pack:** `{prfaq_distillate_artifact}`
...
```json
{
  "status": "complete",
  "prfaq": "{prfaq_main_artifact}",
  "distillate": "{prfaq_distillate_artifact}",
