...
After each section is refined, append it to the output document at `{prfaq_main_artifact}`. Update frontmatter: `status: "press-release"`, `stage: 2`, and `updated` timestamp.
