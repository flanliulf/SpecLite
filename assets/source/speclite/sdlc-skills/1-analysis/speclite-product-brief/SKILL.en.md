...
[Skill Overview]
    Product Brief is a Speclite 分析与项目发现 workflow Skill. It executes the migrated workflow in a target project using the configured communication language, document output language, and runtime paths.
...
[Workflow]
    ...
    5. Before exit, run the quality checks, resolve `workflow.on_complete`, and append `*This document was generated by the speclite-product-brief Skill*` to generated documents.
