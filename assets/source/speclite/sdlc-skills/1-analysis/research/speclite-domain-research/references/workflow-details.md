# Domain Research Workflow Details
...
5. Create the starter output file: `{analysis_artifacts}/research/domain-{{research_topic_slug}}-research-{{date}}.md` with exact copy of the `./research.template.md` contents
