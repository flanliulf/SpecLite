...
2. Analyze against Speclite standards (from prd-purpose.md)
...
- IF A: Invoke the `speclite-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `speclite-party-mode` skill, then return to discussion
