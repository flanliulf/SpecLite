...
Analyze legacy PRD against Speclite standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring Speclite standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against Speclite standard
...
**For each Speclite PRD section, analyze:**
...
- Manually check PRD for each Speclite section
...
**For each Speclite core section:**
...
**[R] Restructure to Speclite** - Full conversion to Speclite format, then apply your edits
...
- All 6 Speclite core sections analyzed for gaps
