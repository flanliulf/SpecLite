...
- 🎯 Detect PRD format (Speclite/legacy)
...
This file defines what makes a great Speclite PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to Speclite format (if legacy PRD)
...
**Check for Speclite PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **Speclite Standard:** 5-6 core sections present
- **Speclite Variant:** 3-4 core sections present, generally follows Speclite patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow Speclite structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is Speclite Standard/Variant:**
...
**[C] Convert to Speclite Format** - Convert PRD to Speclite standard structure, then apply your edits
...
- Speclite PRDs proceed directly to review step
