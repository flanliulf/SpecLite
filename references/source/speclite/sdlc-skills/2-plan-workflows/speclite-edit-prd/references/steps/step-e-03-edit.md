...
- Speclite PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure Speclite PRD principles compliance:
...
- Restructuring: Reformat content to Speclite standard
...
**For restructuring:**
- Reorganize PRD to Speclite standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match Speclite format

**Follow Speclite PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
Speclite standard structure applied.
