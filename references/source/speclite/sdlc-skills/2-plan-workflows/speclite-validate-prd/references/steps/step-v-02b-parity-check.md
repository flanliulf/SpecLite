...
Analyze non-standard PRD and identify gaps to achieve Speclite PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring Speclite PRD standards expertise and gap analysis
...
- 🎯 Analyze each Speclite PRD section for gaps
...
### 1. Analyze Each Speclite PRD Section

For each of the 6 Speclite PRD core sections, analyze:
...
**Overall Effort to Reach Speclite Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core Speclite PRD sections. The overall effort to reach Speclite standard is: **{effort level}**
...
- All 6 Speclite PRD sections analyzed for gaps
