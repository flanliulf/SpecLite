...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience effectiveness (humans and LLMs), Speclite PRD principles compliance, and overall quality rating.
...
- 🎯 Evaluate document flow, dual audience, Speclite principles
...
Invoke the `speclite-advanced-elicitation` skill
...
**3. Speclite PRD Principles Compliance:**
...
- Check Speclite principles compliance
...
**Speclite Principles Compliance:**
...
### Speclite PRD Principles Compliance
...
- Speclite PRD principles compliance checked
...
- Not checking all Speclite principles
