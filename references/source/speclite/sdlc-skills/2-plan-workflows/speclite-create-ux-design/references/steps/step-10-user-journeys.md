...
- Invoke the `speclite-advanced-elicitation` skill with the current user journey content
...
- Invoke the `speclite-party-mode` skill with the current user journeys
