...
- Invoke the `speclite-advanced-elicitation` skill with the current design system content
...
- Invoke the `speclite-party-mode` skill with the current design system choice
