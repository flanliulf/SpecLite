...
- Invoke the `speclite-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `speclite-party-mode` skill with the current responsive/accessibility strategy
