...
- Invoke the `speclite-advanced-elicitation` skill with the current core experience content
...
- Invoke the `speclite-party-mode` skill with the current core experience definition
